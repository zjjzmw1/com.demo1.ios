...
//    [actionSheet showInView:viewController.view];
    ...
    if ([button.currentTitle isEqualToString:@"发布"]) {
        [button setTitle:@"发布2" forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"post_normal"] forState:UIControlStateNormal];
        ...
        [button setTitle:@"发布" forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"account_highlight"] forState:UIControlStateNormal];
        [button setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
