...
- (CYLTabBarController *)tabBarController {
    if (_tabBarController == nil) {
        ...
        RegisterViewController *secondViewController = [[RegisterViewController alloc] init];
        UINavigationController *secondNavigationController = [[UINavigationController alloc]
                                                        initWithRootViewController:secondViewController];
        
        LoginViewController*thirdViewController = [[LoginViewController alloc] init];
        UINavigationController *thirdNavigationController = [[UINavigationController alloc]
                                                       initWithRootViewController:thirdViewController];
        
        RegisterViewController *fourthViewController = [[RegisterViewController alloc] init];
